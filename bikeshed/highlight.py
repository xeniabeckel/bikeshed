...
def highlightWithWebIDL(text: str, el: t.ElementT) -> t.Optional[t.Deque[ColoredText]]:
    ...
    class HighlightMarker:
        ...
        def markup_type_name(self, text: str, construct: widlparser.constructs.Construct) -> t.Tuple[t.Optional[str], t.Optional[str]]:   # pylint: disable=unused-argument
            return ("\1n\2", "\3")

        def markup_name(self, text: str, construct: widlparser.constructs.Construct) -> t.Tuple[t.Optional[str], t.Optional[str]]:   # pylint: disable=unused-argument
            return ("\1g\2", "\3")

        def markup_keyword(self, text: str, construct: widlparser.constructs.Construct) -> t.Tuple[t.Optional[str], t.Optional[str]]:   # pylint: disable=unused-argument
            return ("\1b\2", "\3")

        def markup_enum_value(self, text: str, construct: widlparser.constructs.Construct) -> t.Tuple[t.Optional[str], t.Optional[str]]:   # pylint: disable=unused-argument
            return ("\1s\2", "\3")
