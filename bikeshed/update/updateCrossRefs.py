...
def manualExceptions(spec):
    '''
    For handling a few things I need to manually intervene in for linking purposes.
    '''

    # WebIDL's last snapshot publication was in 2016,
    # it's not suitable for linking at all.
    if spec["vshortname"] == "webidl-1":
        spec["snapshot_url"] = None
